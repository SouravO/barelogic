...
/* Edit only this block to change this section. Nothing else depends   */
/* on it except that it's rendered inside <About /> below.             */
/* ------------------------------------------------------------------ */
...
/* ------------------------------------------------------------------ */
/* Main About section                                                  */
/* Owns the scroll-animation logic and page chrome (background glow,   */
/* grid). Just composes the four sections above — don't add section    */
/* content here, add it to the relevant function instead.              */
/* ------------------------------------------------------------------ */
